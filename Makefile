...
$(deb_file_path): $(file_path).tar
	@echo -e "\nBuilding package for Debian, Mint, Ubuntu...\n"
	$(dist_install)
...
# Creating general .rpm package
$(rpm_file_path): $(file_path).tar
	@echo -e "\nBuilding package for Fedora, Mageia, Mandriva...\n"
	$(dist_install)
	$(create_spec)
...
# Creating .rpm package for OpenSUSE
$(rpm_opensuse_file_path): $(file_path).tar
	@echo -e "\nBuilding package for OpenSUSE...\n"
	$(dist_install)
	$(create_spec)
...
# Creating .rpm package for PCLinuxOS
$(rpm_pclinuxos_file_path): $(file_path).tar
	@echo -e "\nBuilding package for PCLinuxOS...\n"
	$(dist_install)
	$(create_spec)
...
language-template:
	@echo -e "Updating language template...\n"
	@cd $(working_directory); find . -iname "*.py" | xargs xgettext --language=Python --package-name=Sunflower --package-version=0.1 \
	                                                                        --output $(working_directory)/translations/sunflower.pot
	@echo -e "\nDone!\n"
...
version:
	@echo -e "Sunflower version: $(version)\n"
