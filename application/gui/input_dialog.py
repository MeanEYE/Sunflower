...
_use_header_bar = { 'use_header_bar': True } if hasattr(Gtk.Dialog, 'get_header_bar') else {}
...
class InputDialog:
	...
	def __init__(self, application):
		self._dialog = Gtk.Dialog(parent=application, **_use_header_bar)
...
class OverwriteDialog:
	...
	def __init__(self, application, parent):
		self._dialog = Gtk.Dialog(parent=parent, **_use_header_bar)
